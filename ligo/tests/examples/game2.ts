...
import metadata from "../../examples/metadata/game2.json";
...
const tests = () =>
  describe("game2", () => {
    ...
    const codepath = `${__dirname}/../../examples/michelson/game2.tz`;
        ...
        /* Expected TZIP-21 based metadata: 
          {
            ...
            artifactUri: "https://image_url.com/2/1/1.png",
            displayUri: "https://image_url.com/2/1/1.png""
          }
        */
        expect(tokenMetadata.token_info.get("name")).toEqual("47616d6520644e4654");
        expect(tokenMetadata.token_info.get("symbol")).toEqual("47414d45");
        ...
        expect(tokenMetadata.token_info.get("artifactUri")).toEqual(
          "68747470733a2f2f696d6167655f75726c2e636f6d2f322f312f312e706e67"
        );
