...
class Locker(FA2_NFT.FA2_NFT):
    ...
    # Override existing mint entrypoint to accept xtz and initialise a lock
    @sp.entry_point
    def mint(self):
        ...
        # This is kind of redundant due to the replication of key in locks big_map.
        self.data.tokens[lock_count] = sp.unit
    ...
    def withdraw(self, token_id):
        ...
        sp.verify(locked_amount > sp.mutez(0), FA2_NFT.FA2_Errors.FA2_TOKEN_UNDEFINED)
    ...
    def token_metadata(self, token_id):
        ...
        # Verify that token id exist
        sp.verify(locked_amount > sp.tez(0), FA2_NFT.FA2_Errors.FA2_TOKEN_UNDEFINED)
